...
#setwd("Z:/Advanced Analytics/99 - Users/04 - Text Analytics/02 - Projects/01 - Sentiment Analysis")
#install.packages('rsconnect')
#install.packages("https://cran.r-project.org/src/contrib/Archive/Rstem/Rstem_0.4-0.tar.gz")
#install.packages("Z:/Advanced Analytics/99 - Users/04 - Text Analytics/02 - Projects/01 - Sentiment Analysis/my_app2/sentiment_shiny/packrat/lib/x86_64-w64-mingw32/3.2.2/Rstem_0.4-1.tar.gz")
